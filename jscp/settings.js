...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        matrixColor1: '#ff69b4', // Màu pink mẫu
        matrixColor2: '#ff1493', // Màu pink mẫu
        sequence: 'HAPPY|BIRTHDAY|TO|DIVA CANTIK|❤',
        sequenceColor: '#ff69b4', // Màu pink mẫu
        gift: './image/happy3.gif',
        enableBook: true,
        enableHeart: true,
        ...
        pages: [
            ...
            { 
                image: './image/photos/b14.jpg', // Menggantikan 8u5tf7.png (Index 3)
            },

            // --- Lembar 3 (data-page="2") ---
            { 
                image: './image/photos/b5.jpg', // Menggantikan tbutvj.png (Index 4)
                content: 'Happy birthday, Sayang! Hari ini spesial banget karena orang yang paling aku sayang lagi nambah umur. Semoga hari-harimu ke depan selalu dipenuhi hal-hal baik, selalu sehat, dan bahagia terus. Jangan lupa rayain hari ini dengan senyum paling manis, ya🤍!' 
            }
        ]
    };
